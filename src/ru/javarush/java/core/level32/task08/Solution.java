...
public class Solution {
    public static void main(String[] args) {
        ...
        Stream<String> profilesStream = Stream.generate(() ->
                potentialNames.get(random.nextInt(potentialNames.size()))
                        + "-"
                        +(18 + random.nextInt(5))
        );
        List<String> demoUserProfiles = profilesStream.distinct().limit(5).toList();
